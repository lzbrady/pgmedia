...
export default function Pricing({}) {
  return (
    <Container id="pricing">
      <SectionHeader text="Simply Priced Wedding Videos" />
      <TextContainer>
        <Text>Our packages are designed to not let the quality of the video suffer with our cheaper options. We'll work with you to figure out exactly what you are looking for.</Text>
      ...
      <PricingContainer>
        ...
        <PricingCard highlight points={['7-10 minute video*', '10 Hour Day Limit', '2nd Shooter']} price={1400} title="Value" />
        <PricingCard points={['10-20 minute video*', '12 Hour Day Limit', '2nd Shooter', 'Custom Titles & Animations']} price={1800} title="Premium" />
      </PricingContainer>
      ...
      <Button text="Check Availability" containerStyle={{margin: '40px auto 0px'}} linkTo="/contact" />
    </Container>
  );
}
