...
import PrivacyPolicyTitle from 'components/apps/PrivacyPolicyTitle';

export default function SlopeCalcPrivacyPolicy({}) {
  return (
    <div style={{padding: 20}}>
      <PrivacyPolicyTitle title="Slope & Triangle Calculator" color="#7292E9" />
      <p>Luke Brady built the Slope &amp; Triangle Calculator app as a Commercial app. This SERVICE is provided by Luke Brady and is intended for use as is.</p>
      ...
      <p>
        The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Slope &amp; Triangle Calculator unless otherwise defined in this Privacy
        Policy.
      </p>
      <p>
      ...
      <p>
        ...
        option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse our cookies, you may not be able to use some portions of this
        Service.
      </p>
      <p>
      ...
      <p>
        ...
        strongly advise you to review the Privacy Policy of these websites. I have no control over and assume no responsibility for the content, privacy policies, or practices of any third-party sites
        or services.
      </p>
      <p>
      ...
      <p>This policy is effective as of 2021-05-09</p>
      <p>
